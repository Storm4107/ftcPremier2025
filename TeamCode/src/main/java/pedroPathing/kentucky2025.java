...
@TeleOp(name = "kentucky2025")
    ...
    public kentucky2025() {
        super(Lift.INSTANCE, Extension.INSTANCE);
    }
    ...
    public void setGamePad2Commands() {
        ...
        gamepadManager.getGamepad2().getDpadRight().setReleasedCommand(Extension.INSTANCE::fullOut);
        gamepadManager.getGamepad2().getDpadLeft().setReleasedCommand(Extension.INSTANCE::fullIn);
    }
}